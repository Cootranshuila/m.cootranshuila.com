...
<head>
	...
	<link rel="icon" href="assets/images/page/logo-icon.png">
...
<body>
			...
			<div class="page page-home page-with-subnavbar">
				...
				<div class="toolbar tabbar tabbar-labels toolbar-bottom">
					<div class="toolbar-inner">
						<a href="#tab-discover" class="tab-link">
							<i class="ti-star"></i>
						</a>
						<a href="#tab-rooms" class="tab-link">
							<i class="ti-layout"></i>
						</a>
						<a href="#tab-home" class="tab-link tab-link-active">
							<img src="assets/images/page/logo-icon.png" alt="">
						</a>
						<a href="#tab-profile" class="tab-link">
							<i class="ti-user"></i>
						</a>
						<a href="#tab-pages" class="tab-link">
				...
				<div class="tabs">
					...
					<div id="tab-discover" class="tab tab-discover">
									...
									<div class="swiper-container swiper-init" data-space-between="10" data-slides-per-view="auto">
										<div class="swiper-wrapper">
											<div class="swiper-slide">
												<a href="/room-single/">
													<div class="mask"></div>
													<img src="assets/images/discover-slide1.jpg" alt="">
											...
											<div class="swiper-slide">
												<a href="/room-single/">
													<div class="mask"></div>
													<img src="assets/images/discover-slide2.jpg" alt="">
													<div class="availability-info">
														<i class="ti-check-box"></i>
														<span>5</span>
													</div>
											...
											<div class="swiper-slide">
												<a href="/room-single/">
													<div class="mask"></div>
													<img src="assets/images/discover-slide3.jpg" alt="">
													<div class="availability-info">
														<i class="ti-check-box"></i>
														<span>9</span>
													</div>
										...
										<div class="swiper-wrapper">
											<div class="swiper-slide">
												<a href="/room-single/">
													<div class="mask"></div>
													<div class="image">
														<img src="assets/images/luxury-room1.jpg" alt="">
														<div class="symbol-info info-disc">
															<ul>
																<li>50%</li>
																<li>off</li>
															</ul>
											...
											<div class="swiper-slide">
												<a href="/room-single/">
													<div class="mask"></div>
													<div class="image">
														<img src="assets/images/luxury-room2.jpg" alt="">
													</div>
													<div class="image-caption">
														<div class="price-room">
															<h5>$115</h5>
											...
											<div class="swiper-slide">
												<a href="/room-single/">
													<div class="mask"></div>
													<div class="image">
														<img src="assets/images/luxury-room3.jpg" alt="">
													</div>
													<div class="image-caption">
														<div class="price-room">
															<h5>$99</h5>
											...
											<div class="swiper-slide">
												<a href="/room-single/">
													<div class="mask"></div>
													<div class="image">
														<img src="assets/images/luxury-room4.jpg" alt="">
													</div>
													<div class="image-caption">
														<div class="price-room">
															<h5>$160</h5>
					...
					<div id="tab-pages" class="tab tab-pages">
						...
						<div class="pages">
							<div class="container">
								...
								<div class="list">
									<ul>
										<li>
											<a href="/room-single/" class="item-link item-content">
												<div class="item-media">
													<i class="ti-book"></i>
												</div>
												<div class="item-inner">
													<div class="item-title">Room Details</div>
												</div>
											</a>
										</li>
										<li>
											<a href="/blog/" class="item-link item-content">
												<div class="item-media">
													<i class="ti-rss"></i>
												</div>
												<div class="item-inner">
										...
										<li>
											<a href="/blog-single/" class="item-link item-content">
												<div class="item-media">
													<i class="ti-files"></i>
												</div>
												<div class="item-inner">
										...
										<li>
											<a href="/contact-us/" class="item-link item-content">
												<div class="item-media">
													<i class="ti-email"></i>
												</div>
												<div class="item-inner">
										...
										<li>
											<a href="/page-not-found/" class="item-link item-content">
												<div class="item-media">
													<i class="ti-alert"></i>
												</div>
												<div class="item-inner">
													<div class="item-title">Page Not Found</div>
												</div>
											</a>
										</li>
										<li>
	...
	<script src="assets/js/redireccion.js"></script>
